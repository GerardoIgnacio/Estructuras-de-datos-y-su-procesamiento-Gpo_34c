...
* **Descuento por Primera Compra:** Aplica automáticamente un **descuento del 45%** si es la primera compra de un cliente.
...
import openpyxl  # Asegúrate de tenerlo: pip install openpyxl

#
# --- SECCIÓN 1: (Contenido de clases.py) ---
#
class BD:
    """
    Clase para gestionar la conexión y operaciones 
    ...
    def _conectar(self, detect_types=False):
        """Función interna para conectar a la DB."""
        try:
            if detect_types:
    ...
    def _desconectar(self):
        """Función interna para cerrar la conexión."""
        if self.conn:
            self.conn.close()
            self.conn = None
    ...
    def iniciar_tablas(self):
        ...
        try:
            ...
            if conn:
                ...
                # Agregamos 'descripcion' para guardar "Camisa", "Pantalón", etc.
                mi_cursor.execute("""
    ...
    # --- Métodos para Clientes (Sin cambios) ---
    ...
    # --- Métodos para Ventas (Modificados) ---
    ...
    def insertar_venta(self, cliente_id, descripcion, total, descuento, final, fecha_venta):
        ...
        try:
            ...
            if conn:
                mi_cursor = conn.cursor()
                # Se añade 'descripcion' a los valores
    ...
    # Se añade 'descripcion' a la consulta
    ...
    # Se añade 'descripcion' a la consulta de Excel
    def obtener_ventas_para_excel(self):
        """Obtiene los datos específicos para el reporte de Excel."""
        registros = []
        try:
...
#
# --- SECCIÓN 2: (Contenido de funciones.py) ---
#

class Ventas:
    """
    Clase para gestionar la lógica de la aplicación de ventas
    (menús, entradas de usuario, cálculos).
    """
    ...
    # --- FUNCIÓN registrar_venta (MODO MANUAL) ---
    def registrar_venta(self):
        """
        Lógica para registrar una nueva venta, pidiendo datos
        ...
        try:
            ...
            if cliente_id:
                ...
                if num_ventas == 0:
                    ...
                    print(f"Cliente existente (ID: {cliente_id}). ¡Es su primera compra! 🎁")
                else:
                    es_primera_compra = False
            ...
            descripcion_venta = input("Descripción de la venta (Ej. Camisa, Pantalón): ").strip()
            if not descripcion_venta:
                print("La descripción no puede estar vacía. Venta cancelada.")
                return
            ...
            try:
                ...
                print("Monto no válido. Venta cancelada.")
                return
    ...
    def ver_ventas(self):
        ...
        if registros:
            print("ID Venta\tCliente\t\tDescripción\tMonto Total\tDescuento\tMonto Final\tFecha Venta")
            print("-" * 110)
            # Se añade 'desc' (descripcion)
    ...
    def exportar_excel(self):
        ...
        try:
            ...
            # Se añade 'Descripción'
            headers = ["ID de Venta", "Cliente", "Fecha y Hora", "Descripción", "Monto Original", "Descuento Aplicado", "Total de la Venta"]
            hoja.append(headers)
            ...
            for row_num in range(2, hoja.max_row + 1):
                ...
                # Col 4: Descripción (es texto, sin formato)
...
if __name__ == "__main__":
    ...
    # 2. Se asegura de que las tablas estén creadas
    bd_ventas.iniciar_tablas()
    
    # 3. Crea el objeto que maneja la lógica de la aplicación
